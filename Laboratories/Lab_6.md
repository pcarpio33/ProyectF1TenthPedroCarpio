...
<p align="center">
  <img src="img/rrt_algo.png" />
  <br />
  <em>Figure 1: Pseudocode</em>
</p>
...
You can implement RRT*, or another modified version of RRT. On top of the basic version of RRT, RRT* uses a cost function, and rewiring the tree, to find a better path to the goal. When the tree has expanded infinite number of nodes, RRT*'s solution is close to optimal. Figure 3 shows the difference in the tree expanded and path found between RRT and RRT*. The skeleton code provided has sections for functions in RRT* as well.
